...
if(isset($_POST['page'])&&isset($_POST['key'])){
    ...
    $sql = "select `goods_id`,`goods_name`,`ershou_sell`,`ershou_sell_money`,`goods_description`,`goods_img1`,`goods_img2`,`goods_img3`,`chuzu_money` from goods WHERE `goods_name`='%$key%' OR `goods_description`='%$key%' order by upload_time DESC";
    $beishu = 4;
    $tiao = $page*($beishu);
